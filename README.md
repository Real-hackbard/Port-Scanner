...
![Last Update](https://github.com/user-attachments/assets/e1d05f21-2a01-4ecf-94f3-b7bdff4d44dd) <img src="https://github.com/user-attachments/assets/3f3bb217-bcad-4e4b-916f-da70dac78df8" />  
...
<img src="https://github.com/user-attachments/assets/07f7d8ee-ef93-4981-bf27-77af95cd094f" />
...
| ```-o```     | Displays active TCP connections and includes the process ID ([PID](https://de.wikipedia.org/wiki/Process_identifier)) for each connection. You can find the application based on the PID on the Processes tab in Windows Task Manager. This parameter can be combined with ```-a```, ```-n```, and ```-p```. |
